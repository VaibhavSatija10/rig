...
async fn main() -> Result<(), anyhow::Error> {
    ...
    // Initialize the Mira client with API key directly
    let api_key = "sk-mira-588aec4efa47e1e1a7c1e790f20d7b596204ab084a775c9a";
    println!("Initializing Mira client...");
    println!("API Key (first 10 chars): {}", &api_key[..10]);

    let client = providers::mira::Client::new(api_key)
        .map_err(|e| anyhow::anyhow!("Failed to initialize Mira client: {}", e))?;
    println!("Mira client initialized successfully");
